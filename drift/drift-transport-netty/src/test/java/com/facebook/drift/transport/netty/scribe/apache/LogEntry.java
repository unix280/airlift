 ...
 */
package com.facebook.drift.transport.netty.scribe.apache;
        ...
        implements org.apache.thrift.TBase<LogEntry, LogEntry._Fields>, java.io.Serializable, Cloneable, Comparable<LogEntry>
{
    ...
    private static final SchemeFactory STANDARD_SCHEME_FACTORY = new LogEntryStandardSchemeFactory();
    private static final SchemeFactory TUPLE_SCHEME_FACTORY = new LogEntryTupleSchemeFactory();
    ...
    @Override
    public int compareTo(LogEntry typedOther)
    {
        if (!getClass().equals(typedOther.getClass())) {
            return getClass().getName().compareTo(typedOther.getClass().getName());
        }
    ...
    private static class LogEntryStandardSchemeFactory
    ...
    private static class LogEntryStandardScheme
            extends StandardScheme<LogEntry>
    {
    ...
    private static class LogEntryTupleSchemeFactory
            implements SchemeFactory
    {
    ...
    private static class LogEntryTupleScheme
            extends TupleScheme<LogEntry>
    {
        @Override
