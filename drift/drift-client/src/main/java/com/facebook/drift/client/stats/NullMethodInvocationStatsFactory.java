...
public final class NullMethodInvocationStatsFactory
        implements MethodInvocationStatsFactory
{
    @Override
    public MethodInvocationStat getStat(ThriftServiceMetadata serviceMetadata, Optional<String> qualifier, MethodMetadata metadata)
    {
